...
The application is running on (https://sghost27.shinyapps.io/Developing-Data-products-week4/)

ui.R, and Server.R Code in my github repository (https://github.com/sghost27/Developing-Data-Products-Week-4)
